...
SPECIFICITY REQUIREMENTS (final scorecard):
  ...
  - 'next_steps_plan' (2-4 items): each item is a concrete, drillable prep action of 8-20 words. Banned: "study more", "review fundamentals", "practice cases". Required: name the topic AND the form of practice. Example: "Walk through 5 LBO returns problems with explicit MOIC and IRR per tranche", "Re-derive the EV-to-Equity bridge from scratch on paper". If a SKILL PROFILE is provided, at least one item MUST target the named weakest axis (e.g. depth -> drill edge cases/sensitivities; structure -> framework-first reps; communication -> answer-first delivery; correctness -> the specific mechanic missed).
