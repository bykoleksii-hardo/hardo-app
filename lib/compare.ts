...
const COMMON_ROWS = (rival: {
  ...
  { feature: 'Candidate levels', hardo: 'Three rooms — Intern, Analyst, Associate — graded to each level’s bar', rival: rival.levels },
...
export const COMPARISONS: Comparison[] = [
  {
    ...
    intro: 'Both run AI investment banking mock interviews, but they aim at different jobs. Cook’d AI is a broad recruiting suite — interviews plus resume help, networking and an application tracker. HARDO is narrower and deeper: the interview itself, graded the way a real banker would, with delivery scored and three candidate levels.',
    ...
    rows: COMMON_ROWS({
      ...
      levels: 'Not advertised as distinct candidate levels',
    ...
    hardoEdge: [
      ...
      { h: 'Three candidate levels', p: 'Intern, Analyst and Associate rooms, each graded against the bar for that level instead of a generic one.' },
  ...
  },
  {
    ...
    description: 'HARDO vs Superday AI for investment banking mock interviews: a graded practice rep with three candidate levels and delivery scoring vs bank-specific coverage and a live interview copilot.',
    h1: 'HARDO vs Superday AI',
    intro: 'Both are AI investment banking mock interview tools. Superday AI leans on bank-specific question coverage and a real-time “interview copilot”. HARDO leans on the practice rep itself: three candidate levels, a director-style scorecard on every answer, and delivery scored in voice mode — built to make you better, not to assist you live.',
    pickHardoIf: 'you want to build the skill through honest, graded reps — with three candidate levels and delivery feedback — at a transparent price.',
    ...
    hardoEdge: [
      ...
      { h: 'Three candidate levels', p: 'Intern, Analyst and Associate, each graded to that level’s bar — useful as you move from first-round to superday.' },
    ...
    faq: [
      { q: 'Is HARDO a good Superday AI alternative?', a: 'Yes, especially if you want a graded practice rep with three candidate levels and delivery scoring rather than a real-time copilot.' },
...
export const ROUNDUP_TOOLS: Tool[] = [
  { name: 'HARDO', url: '/ai-investment-banking-mock-interview', internal: true, line: 'A graded mock interview rep: 12 questions across technicals, behavioral and a case, three candidate levels, a letter grade on every answer and delivery scored in voice mode. One free, $14.99/mo.' },
