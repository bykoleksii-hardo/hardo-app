...
export const CASES: EvalCase[] = [
  // ---- Technical: strong ----
  {
    ...
    expect: { band: ['A', 'A-'], axes: { correctness: [3, 4], structure: [3, 4] }, note: 'clean, correct linkage' },
  },
  {
    id: 'dcf-walk-strong',
    level: 'analyst',
    ...
    expect: { band: ['A', 'A-'], axes: { correctness: [3, 4], depth: [2, 4] } },
  },
  {
    ...
    expect: { band: ['A', 'A-'], axes: { correctness: [3, 4], depth: [3, 4] } },
  },
  {
    id: 'lbo-walk-strong',
    level: 'associate',
    ...
    expect: { band: ['A', 'A-'], axes: { correctness: [3, 4], depth: [3, 4], communication: [3, 4] } },
  },
  {
    ...
    expect: { band: ['A', 'A-', 'B+'], axes: { correctness: [3, 4] }, note: 'intern bar: framework + correct in spirit' },
  },
  ...
  // ---- Technical: mid ----
  {
    ...
    expect: { band: ['B', 'B-', 'B+'], note: 'right idea, no numbers / mechanics light' },
  },
  {
    ...
    expect: { band: ['B+', 'B', 'B-'], note: 'correct but shallow, no financing nuance' },
  },
  {
    ...
    expect: { band: ['B+', 'B', 'B-'], axes: { depth: [1, 3] } },
  },
  ...
  // ---- Technical: weak ----
  {
    ...
    expect: { band: ['C+', 'C', 'C-', 'D'], axes: { correctness: [0, 2], depth: [0, 1] }, note: 'asserted, no WACC build-up' },
  },
  {
    ...
    expect: { band: ['C', 'C-', 'D', 'F'], axes: { correctness: [0, 1] }, note: 'fundamentally confused' },
  },
  {
    id: 'nonanswer-idk',
    level: 'analyst',
  ...
  // ---- Fit / behavioral ----
  {
    ...
    expect: { band: ['A', 'A-'], axes: { correctness: [3, 4], depth: [2, 4] }, note: 'fit rubric: substance + specificity' },
  },
  {
    id: 'why-ib-generic',
    level: 'intern',
    ...
    expect: { band: ['C+', 'C', 'C-'], axes: { depth: [0, 1] }, note: 'all generic, no specifics' },
  },
  {
    ...
    expect: { band: ['A-', 'B+', 'A'], axes: { correctness: [3, 4], structure: [3, 4] } },
  },
  {
    ...
    expect: { band: ['A', 'A-'], axes: { depth: [3, 4], structure: [3, 4], communication: [3, 4] }, note: 'clean STAR, quantified, judgment' },
  },
  {
    id: 'deal-vague',
    level: 'analyst',
    ...
    expect: { band: ['C+', 'C', 'C-'], axes: { depth: [0, 1] }, note: 'no names, no numbers, no thesis' },
  },
];
