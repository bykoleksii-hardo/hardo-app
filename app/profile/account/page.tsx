  ...
  return (
    <div className="space-y-10 max-w-3xl">
      <Section title="SIGN-IN" subtitle="The account this profile belongs to.">
        <div className="border border-[#11161E]/10 rounded-sm p-5">
          <div className="text-[11px] tracking-[0.18em] text-[#11161E]/55">EMAIL</div>
          <div className="font-serif text-lg mt-1">{user.email}</div>
          <div className="text-[11px] tracking-[0.05em] text-[#11161E]/45 mt-2">Signed in via Supabase auth</div>
        </div>
      </Section>
      ...
      >
        <div className="border border-[#11161E]/10 rounded-sm p-5 flex items-center justify-between gap-6">
          <div>
      ...
      <Section title="DEFAULTS" subtitle="Your last picks come back next time you start a new interview.">
        <div className="border border-[#11161E]/10 rounded-sm p-5">
          <div className="text-[11px] tracking-[0.18em] text-[#11161E]/55">DEFAULT LEVEL</div>
          <div className="font-serif text-lg mt-1 capitalize">{row?.candidate_level ?? 'Intern'}</div>
          <div className="text-[11px] tracking-[0.05em] text-[#11161E]/45 mt-2">Auto-set from your most recent interview.</div>
        </div>
      </Section>
  ...
  return (
    <section className="space-y-4">
      <div>
        ...
        {subtitle && <p className="text-sm text-[#11161E]/60 mt-1 max-w-xl">{subtitle}</p>}
      </div>
